    ...
    return (
        <div className="-z-20 absolute top-[5vw] right-[5vw] w-[9vw] h-[8.5vw]">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 131 136" fill="none">
                ...
                <path d="M19.2682 18.3822C19.8774 20.8066 19.5256 23.2337 19.2862 25.6772C18.5006 33.7008 15.3552 42.0309 9.71151 47.2933C17.1379 44.0371 27.7921 42.619 34.5374 48.3347" stroke="black" strokeWidth="3.37884" strokeMiterlimit="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
        </div>
    )
}
        ...
        <section className="pt-[7.708vw] pb-[10vw] overflow-hidden">
            <div className="container grid grid-cols-2">
                ...
                <div className="relative">
                    <div className={"absolute bg-image bg-[url('/src/assets/nft/2.jpg')] after:-z-10 after:absolute after:bg-[url('/src/assets/nft/2.jpg')] after:blur-[3vw] duration-1000 " + (switcher === 0 ? 'bottom-[24%] right-[40%] rounded-25 w-[27.1vw] h-[27.4vw] after:w-[27.1vw] after:h-[27.4vw]' : 'bottom-[4vw] right-[-20%] rounded-22 w-[22.16vw] h-[22.3vw] after:w-[20.16vw] after:h-[20.3vw]')}></div>
