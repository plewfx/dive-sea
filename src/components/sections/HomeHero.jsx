...
export const Switcher = ({ className, switcher, setSwitcher}) => {
    return (
        <div className={"rounded-17 bg-grey-FC p-21 grid grid-cols-3 grid-rows-1 gap-[2.4vw] after:w-[0.14vw] after:h-[1.8vw] after:bg-grey-ED after:justify-self-center shadow-[0_3vw_2.36vw_-1vw_rgba(15,15,15,0.12)] dark:bg-black-14 dark:shadow-[0vw_0.81vw_4.08vw_0vw_rgba(0,0,0,0.9)] dark:after:bg-grey-60 " + className}>
