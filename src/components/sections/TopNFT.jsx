    ...
    return (
        <section className="pt-70 pb-100 bg-grey-F1 dark:bg-black-14">
            <div className="container flex flex-col gap-[40vw] relative">
                ...
                <div className={"flex gap-40 absolute top-[8vw] duration-1000 " + (switcher === 1 ? 'left-[-30%]' : 'left-[0%]')}>
                    {
                        NFTs.map(nft => {
                            return (
                                <NFT
                                    ...
                                    return (
                                        <div key={col.id} className="flex items-center justify-between">
                                            <div className="grid grid-rows-2 grid-cols-[3vw_100%] gap-x-22 gap-y-5">
                                                <div style={{backgroundImage: `url(${col.img})`}} className={`relative bg-image row-span-full rounded-[50%] w-[3.2vw] h-[3.2vw]`}>
                                                    <span className="absolute -bottom-[0.2vw] -right-[0.2vw] bg-white text-11 font-150 font-bold py-2 px-8 rounded-[50%]">
                                                        {col.id}
                                                    </span>
                                                </div>
